...
#define SHKMyAppName			@"ShareMyPics"
#define SHKMyAppURL				@"http://www.fr4ncis.net"
...
#define SHKFacebookKey				@"254401274658199"
#define SHKFacebookSecret			@"72e6006b8dc9eb1a92cf94ce9bd2df1f"
 ...
 */
#define SHKTwitterConsumerKey		@"uuNPJAso9wS5bAm1M85Sfw"
#define SHKTwitterSecret			@"gPVL6SmoIuLKsqIspXkvhLN62LtG8BbCI3FU9Cs"
#define SHKTwitterCallbackUrl		@"http://www.fakeurl.com/oauth" // You need to set this if using OAuth, see note above (xAuth users can skip it)
...
#define SHKBitLyLogin				@"" // @"fr4ncis"
#define SHKBitLyKey					@"" //@"R_3609ebab4f998bb2520d504f48ef72d6"
